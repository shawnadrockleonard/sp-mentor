...
(function (mentor) {
    var MentorContextModel = (function () {
        function MentorContextModel() {
            ...
            this.clientContext = ko.observable();
            this.hostWeb = ko.observable();
            this.appWeb = ko.observable();
            ...
            this.getHostWebDetails = function execHostWebTitleQuery() {
                var self = this;
                self.clientContext().load(self.hostWeb(), 'Title', 'Url');
                //Execute the query with all the previous 
                //  options and parameters
                self.clientContext().executeQueryAsync(Function.createDelegate(this, successHandler), Function.createDelegate(this, errorHandler));
            ...
            this.load = function (successHandler, errorHandler) {
                var self = this;
                ...
                if (!self.contextLoaded()) {
                    ...
                    jQuery.getScript(self.scriptBaseUrl() + "SP.Runtime.js", function () {
                        jQuery.getScript(self.scriptBaseUrl() + "sp.core.js", function () {
                            jQuery.getScript(self.scriptBaseUrl() + "SP.js", function () {
            ...
            this.listQuery = function (listName, camlQueryXml, lkupSuccessHandler, lkupErrorHandler) {
                var self = this;
                ...
                self.clientContext().executeQueryAsync(Function.createDelegate(this, function (e, args) {
            ...
            */
            this.getCurrentUser = function (userSuccessHandler, userErrorHandler) {
                var self = this;
                var userContext = self.hostWeb().get_currentUser();
                self.clientContext().load(userContext);
                self.clientContext().executeQueryAsync(Function.createDelegate(null, function (e, args) {
                    userSuccessHandler(e, args, userContext);
                }), Function.createDelegate(null, userErrorHandler));
            };
            this.saveMentor = function (mentormodel, saveSuccessHandler, saveErrorHandler) {
                var self = this;
                ...
                self.clientContext().executeQueryAsync(Function.createDelegate(this, saveSuccessHandler), Function.createDelegate(this, saveErrorHandler));
            };
