...
function UpdateUrlWhenServerRedirects() {
    ...
    if (Flighting.VariantConfiguration.IsExpFeatureClientEnabled(708) && !(window["OffSwitch"] == null || OffSwitch.IsActive("B5F7385C-A503-4916-AFC2-39AEE7667ED7")) && Boolean(pageContextInfo) && Boolean(pageContextInfo.serverRedirectedUrl)) {
...
function PerformanceLogger_module_def() {
    ...
    PerformanceLogger.Logger = function(cacheLogger) {
        ...
        this.AddExpectedControl = function(control) {
            if (expectedControls.indexOf(control) === -1) {
