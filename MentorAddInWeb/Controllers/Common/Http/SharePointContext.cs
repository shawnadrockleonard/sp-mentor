...
namespace MentorAddInWeb.Common.Http
{
    ...
    public abstract class SharePointContextProvider
    {
        ...
        public SharePointContext GetSharePointContext(HttpContextBase httpContext)
        {
            ...
            // Moving after context/session check
            Uri spHostUrl = SharePointContext.GetSPHostUrl(httpContext.Request);
            if (spHostUrl == null && spContext == null)
            {
                return null;
            }
    ...
    public class SharePointAcsContextProvider : SharePointContextProvider
    {
        ...
        protected override SharePointContext LoadSharePointContext(HttpContextBase httpContext)
        {
            try
            {
                var sessionContext = httpContext.Session[SPContextKey];
                return sessionContext as SharePointAcsContext;
            }
            catch (Exception ex)
            {
                // log exception and move along
            }
            return null;
        }
    ...
    public class SharePointHighTrustContextProvider : SharePointContextProvider
    {
        ...
        protected override SharePointContext LoadSharePointContext(HttpContextBase httpContext)
        {
            ...
            {
                var sessionContext = httpContext.Session[SPContextKey];
                return sessionContext as SharePointHighTrustContext;
            }
            catch (Exception ex)
            {
                // log exception and move along
